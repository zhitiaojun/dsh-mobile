...
`;
		...
		*/
		...
		function installControl() {
			...
			const cloudflareSummaryTitle = element("strong");
			cloudflareSummaryTitle.textContent = t("cloudflareName");
			const cloudflareSummaryDescription = element("span");
			cloudflareSummaryDescription.textContent = t("cloudflareDescription");
			const cloudflareBadge = element("span", "dsh-mobile-control__provider-badge is-frp");
			cloudflareBadge.textContent = t("advanced");
